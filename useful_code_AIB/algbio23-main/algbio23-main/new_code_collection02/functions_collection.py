...
def alt_alt_merge_united(guide_PA,MSA_list,in_which_MSA_is_it,node1,node2):
    ...
    def integrity_check_OBO(seqs, in_which_MSA_is_it, who_aligned_to_who, MSA_list,matrix):
...
def new_assembly_OBO_x(seqs,score_matrix,gapcost, check_integrity=False):
    ...
    if check_integrity==True:
       integrity_check_OBO(seqs,in_which_MSA_is_it,who_aligned_to_who,MSA_list, matrix)
    total_cost = compute_cost(MSA_list[0], score_matrix, gap_cost)
